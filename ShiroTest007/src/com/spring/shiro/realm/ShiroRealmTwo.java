...
public class ShiroRealmTwo extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        //这里把密码写错，测试只有一个Realm认证正确，是否会通过验证
        //认证策略是AtLeastOneSuccessfulStrategy
        ...
        SimpleAuthenticationInfo authc = new SimpleAuthenticationInfo("realmTwo",credentials,credentialSalt,realmName);
        return authc;
